...
/**
 * A class for writing numeric and string sequences into a TXT file
 * 
...
public class SequenceTXTWriter{
	...
	/**
	 * Writes a string sequence in a file, in TXT format
	 * 
	...
	/**
	 * Writes a numeric sequence in a file, in TXT format
	 * 
	 * @param seq sequence to write
	 * @param file path of the file
	 */
