...
/**
 * XML format for reading the Kolmogorov Two Sample distribution table
 * 
 * @author Joaquín Derrac Rus (jderrac@decsai.ugr.es)
 * @version 1.0
 */
public class KolmogorovTwoSampleReaderFormat extends DefaultHandler {
	 ...
	 * Default builder
	 */
	public KolmogorovTwoSampleReaderFormat(){
	...
	private void clearTables(){
		...
		KolmogorovTwoSampleDistribution.getExactTable().clear();
	...
	private void addElement(){
		...
		KolmogorovTwoSampleDistribution.getExactTable().add(x, y, z, prob);
