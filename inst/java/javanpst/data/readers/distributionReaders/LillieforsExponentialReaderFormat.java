...
/**
 * XML format for reading the Lilliefors distribution table
 * 
 * @author Joaquín Derrac Rus (jderrac@decsai.ugr.es)
 * @version 1.0
 */
public class LillieforsExponentialReaderFormat extends DefaultHandler {
	 ...
	 * Default builder
	 */
	public LillieforsExponentialReaderFormat(){
	...
	private void clearTable(){
		...
		LillieforsDistribution.getExponentialTable().clear();
	...
	private void addRow(){
		...
		LillieforsDistribution.getExponentialTable().addRow(n, probs);
