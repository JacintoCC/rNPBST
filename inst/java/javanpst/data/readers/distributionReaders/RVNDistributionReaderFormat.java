...
/**
 * XML format for reading the Ranks Von Newmann distribution table
 * 
 * @author Joaquín Derrac Rus (jderrac@decsai.ugr.es)
 * @version 1.0
 */
public class RVNDistributionReaderFormat extends DefaultHandler {
	 ...
	 * Default builder
	 */
	public RVNDistributionReaderFormat(){
	...
	private void clearTable(){
		...
		RVNDistribution.getTable().clear();
	...
	private void addRow(){
		...
		RVNDistribution.getTable().addRow(n, probs);
