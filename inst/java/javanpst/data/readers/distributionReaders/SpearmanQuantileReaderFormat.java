...
/**
 * XML format for reading the Spearman Quantile distribution table
 * 
 * @author Joaquín Derrac Rus (jderrac@decsai.ugr.es)
 * @version 1.0
 */
public class SpearmanQuantileReaderFormat extends DefaultHandler {
	 ...
	 * Default builder
	 */
	public SpearmanQuantileReaderFormat(){
	...
	private void clearTable(){
		...
		SpearmanDistribution.getCriticalTable().clear();
	...
	private void addRow(){
		...
		SpearmanDistribution.getCriticalTable().addRow(n, probs);
