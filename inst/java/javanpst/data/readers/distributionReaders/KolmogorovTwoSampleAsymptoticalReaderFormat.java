...
/**
 * XML format for reading the Kolmogorov Two Sample Asymptotical distribution table
 * 
 * @author Joaquín Derrac Rus (jderrac@decsai.ugr.es)
 * @version 1.0
 */
public class KolmogorovTwoSampleAsymptoticalReaderFormat extends DefaultHandler {
	 ...
	 * Default builder
	 */
	public KolmogorovTwoSampleAsymptoticalReaderFormat(){
	...
	private void clearTable(){
		...
		KolmogorovTwoSampleDistribution.getTable().clear();
	...
	private void addRow(){
		...
		KolmogorovTwoSampleDistribution.getTable().addRow(n, probs);
