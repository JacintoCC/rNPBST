...
/**
 * XML format for reading the Kendall Quantile distribution table
 * 
 * @author Joaquín Derrac Rus (jderrac@decsai.ugr.es)
 * @version 1.0
 */
public class KendallQuantileReaderFormat extends DefaultHandler {
	 ...
	 * Default builder
	 */
	public KendallQuantileReaderFormat(){
	...
	private void clearTable(){
		...
		KendallDistribution.getCriticalTable().clear();
	...
	private void addRow(){
		...
		KendallDistribution.getCriticalTable().addRow(n, probs);
