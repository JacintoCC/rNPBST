...
/**
 * XML format for reading the Kolmogorov distribution table
 * 
 * @author Joaquín Derrac Rus (jderrac@decsai.ugr.es)
 * @version 1.0
 */
public class KolmogorovReaderFormat extends DefaultHandler {
	...
	private void clearTable(){
		...
		KolmogorovDistribution.getTable().clear();
	...
	private void addRow(){
		...
		KolmogorovDistribution.getTable().addRow(n, probs);
